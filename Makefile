...
ifndef NEMODB_PATH
$(warning Warning: missing nemo-rocksdb path, using default: $(CURDIR)/3rdparty/nemo-rocksdb)
NEMODB_PATH=$(CURDIR)/3rdparty/nemo-rocksdb
endif
...
clean:
	...
	rm -rf $(CLEAN_FILES)
	rm -rf $(LIBOUTPUT)
	find . -name "*.[oda]*" ! -path "./3rdparty/*" -exec rm -f {} \;
